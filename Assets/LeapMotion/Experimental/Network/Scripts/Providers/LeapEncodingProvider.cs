...
namespace Leap.Unity.Networking {
  public class LeapEncodingProvider : LeapProvider {
    ...
    public virtual void Start() {
      ...
      //InteractionBox box = new InteractionBox(new Vector(0f, 0f, 0f),
      //  new Vector(100f, 100f, 100f));          // Removed since Core 4.4.
      currentFrame.Id = frameID;
      currentFrame.CurrentFramesPerSecond = 110f;
      //currentFrame.InteractionBox = box;        // Removed since Core 4.4.

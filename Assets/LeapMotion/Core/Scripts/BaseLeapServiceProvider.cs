...
namespace Leap.Unity {
  ...
  /// <summary>
  /// The abstract LeapServiceProvider provides tracked Leap Hand data and images from the device
  /// via the Leap service running on the client machine.
  /// </summary>
  public abstract class BaseLeapServiceProvider : LeapProvider {
    ...
    protected Action<Device> _onDeviceSafe;
    /// <summary>
...
#if UNITY_EDITOR
    protected Frame _backingUntransformedEditTimeFrame = null;
    protected Frame _untransformedEditTimeFrame {
      get {
    ...
    protected Frame _backingEditTimeFrame = null;
    protected Frame _editTimeFrame {
      get {
    ...
    protected Dictionary<TestHandFactory.TestHandPose, Hand> _cachedLeftHands
      = new Dictionary<TestHandFactory.TestHandPose, Hand>();
    protected Hand _editTimeLeftHand {
      get {
        Hand cachedHand;
    ...
    protected Dictionary<TestHandFactory.TestHandPose, Hand> _cachedRightHands
      = new Dictionary<TestHandFactory.TestHandPose, Hand>();
    protected Hand _editTimeRightHand {
      get {
        Hand cachedHand;
